...
<div class="container p-3">
    <div class="row">
        <div class="col-8">
            <h4>Galeri SMA <code>&lt;Koding&gt;</code> 1</h4>
            <img src="../../assets/img/123.jpg" alt="" width="200">
            <img src="../../assets/img/345.jpg" alt="" width="200">
            <img src="../../assets/img/102.jpg" alt="" width="200">
        </div>
        <div class="col-4">
